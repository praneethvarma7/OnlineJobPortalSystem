...
const RecruiterProfile = () => {
    ...
    const handleFormSubmit = async (e) => {
        ...
        formData.append('recruiterimage', data.recruiterimage);
        ...
        try {
            const response = await axios.put('http://localhost:8081/recruiterProfile', formData, {
                headers: {
                    ...
                    <div className="row g-4">
                            ...
                            <div className="bg-light p-5 h-100 d-flex align-items-center">
                                <form onSubmit={handleFormSubmit}>
                                    <div className="row g-3" style={{ marginRight: '300px' }}>
                                        ...
                                        <div className="col-md-6">
                                            <div className="form-floating">
                                                <input type="text" className="form-control" id="name" name="company" placeholder="Company" value={data.company}
                                                    onChange={(e) => setData({ ...data, company: e.target.value })} readOnly />
                                                <label for="name">Company</label>
                                            </div>
                                        </div>
                                        <div className="col-12">
                                            <div className="form-floating">
                                                <input type='email' className="form-control" placeholder="Your Email" id="email" name="email"
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <input
                                                ...
                                                onChange={(e) => {
                                                    ...
                                                    setData({ ...data, recruiterimage: selectedFile });
                                                }}
                                            />
                                            {data.recruiterimage && (
                                                <p style={{ marginTop: '5px' }}>Selected File: {data.recruiterimage}</p>
                                            )}
                                        </div>
                        ...
                        <div className="col-md-6 wow fadeInUp" data-wow-delay="0.1s" style={{ marginLeft: '73%', marginTop: '-31%' }}>
                            <div class="position-relative h-100 wow fadeInUp" data-wow-delay="0.5s">
                                <img class=" bg-lightblue w-50 h-69" src={`http://localhost:8081/images/` + data.recruiterimage} alt="" />
                            </div>
                        </div>
                    </div>
                </div>
