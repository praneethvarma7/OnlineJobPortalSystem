...
const ChangePassword = () => {
    ...
    return (
        <div>
            <marquee style={{ fontFamily: 'Monotype Corsiva', height: '35px', backgroundColor: 'lightblue', fontWeight: 'bold', marginTop: '1%' }}>
                <h4 style={{ fontFamily: 'Monotype Corsiva' }}>Change Password!</h4>
            </marquee>
